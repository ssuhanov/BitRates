...
class DataDeserializerTests: XCTestCase {
    ...
    var correctDataModel: CMDataModel!
    
    override func setUp() {
        super.setUp()
        
        self.correctDataModel = CMDataModel.builder
            .data(CMData.builder
                .the1(CMThe1.builder
    ...
    func testDeserializeWithData() {
        ...
        let result: CMDataModel? = self.instance.deserialize(serverResponse: serverResponse)
